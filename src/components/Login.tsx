...
export default function Login({ onLogin }: LoginProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md">
        ...
        {!isNewUser && (
          <p className="text-center text-sm text-purple-600 dark:text-purple-400 mb-4 cursor-pointer hover:underline" onClick={() => setIsNewUser(true)}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-center text-2xl tracking-widest mb-4"
            maxLength={6}
            required
          />
          {isNewUser && (
        ...
        {isNewUser && (
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center mt-4">
            <button type="button" onClick={() => setIsNewUser(false)} className="text-purple-600 dark:text-purple-400 hover:underline">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col items-center gap-3">
            <img src="/logo_black_small.png" alt="Port42 Developments" className="h-8 w-auto opacity-80 dark:opacity-60" />
